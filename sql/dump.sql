...
CREATE TABLE `lead` (
  ...
  `location_id` int(11) NOT NULL,
  KEY `pet_id` (`pet_id`),
  CONSTRAINT `lead_ibfk_1` FOREIGN KEY (`pet_id`) REFERENCES `pet` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-03-28 16:19:54
